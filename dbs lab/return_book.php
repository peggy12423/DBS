...
<body>
        <form action="return_record.php" method="post">

            <div class="container">
                  <h3><p align="center">歸還書籍資料表</p></h3><br>
                  <label  class="mb-2 mr-sm-2">歸還者：</label>
                  <input class="form-control mb-2 mr-sm-2" name="user" id='user' placeholder="請輸入歸還者帳號"/><br>
