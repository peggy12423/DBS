...
<body>
    ...
    <?php
        ...
        $sql3 = "SELECT * FROM person WHERE user='$user'";
        ...
        if( $row1 == 0 ){
            ?><center><?php   
                ...
                echo '<meta http-equiv=REFRESH CONTENT=2;url=manager_borrow_book.php>';
        }
        elseif( $row3 == 0 ){
            ?><center><?php   
                echo  "<br><br><br><h2>查無 $user 此帳號!</h2>";
                echo '<meta http-equiv=REFRESH CONTENT=2;url=manager_borrow_book.php>';
        }
        elseif( $row2 != 0 ){
            ?><center><?php 
                ...
                echo '<meta http-equiv=REFRESH CONTENT=5;url=manager_borrow_book.php>';
            ...
            $name = mysqli_fetch_row( $res3 );
                ...
                $mail->SMTPAuth = true;
                $mail->Username = 'peggy12423@gmail.com';//己的email
