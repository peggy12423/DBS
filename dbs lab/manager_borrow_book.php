...
<body>
        <form action="manager_borrow_record.php" method="post">

            <div class="container">
                  <h3><p align="center">借閱書籍資料表</p></h3><br>
                  <label  class="mb-2 mr-sm-2">借閱者：</label>
                  <input class="form-control mb-2 mr-sm-2" name="user" id='user' placeholder="請輸入借閱者帳號"/><br>
